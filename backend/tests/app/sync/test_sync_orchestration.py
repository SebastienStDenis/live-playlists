...
from app.sync.sync_activities import (
...
def patch_session_factory(monkeypatch: pytest.MonkeyPatch, session: AsyncMock) -> None:
    ...
    monkeypatch.setattr("app.sync.sync_activities.session_factory", factory)
...
async def test_sync_artists_activity_commits_and_wraps_results(
    ...
    monkeypatch.setattr("app.sync.sync_activities.sync_lastfm_artists", sync)
...
async def test_audit_bot_playlists_activity_commits(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("app.sync.sync_activities.audit_bot_playlists", audit)
...
async def test_drain_playlist_tombstones_activity_commits(
    ...
    monkeypatch.setattr("app.sync.sync_activities.drain_playlist_tombstones", drain)
